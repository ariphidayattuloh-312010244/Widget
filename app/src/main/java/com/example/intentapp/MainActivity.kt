    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            R.id.btn_move_activity_data -> {
                ...
                moveIntentWithData.putExtra(MoveActivityWithData.YOUR_NAME,"Arip Hidayattuloh")
                moveIntentWithData.putExtra(MoveActivityWithData.YOUR_CLASS,"TI.20.B.1")
                moveIntentWithData.putExtra(MoveActivityWithData.YOUR_AGE, 30)
            ...
            R.id.btn_move_activity_with_object -> {
                val objectmhs = Mahasiswa(
                    ...
                    "TI.20.B.1",
                    30,
                    "arip-hidayat@mhs.pelitabangsa.ac.id",
                    "Bekasi"
                )
